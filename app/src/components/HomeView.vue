...
const economicIndicators = ref([
  ...
  { label: 'WTI', value: '78.25', change: '-1.2%', isPositive: false },
  ...
  <div class="max-w-6xl mx-auto">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
      <div class="bg-white rounded-xl shadow-sm p-6 border border-gray-200">
        <h2 class="text-xl font-bold text-gray-800 mb-4">당일 시장 주요 이벤트</h2>
        <ul class="space-y-3">
          <li 
      ...
      <!-- 경제 캘린더 -->
      <div class="bg-white rounded-xl shadow-sm p-6 border border-gray-200">
        <h2 class="text-xl font-bold text-gray-800 mb-4">주요 경제 이벤트</h2>
